start java -cp "bank.jar" branch.server.BranchServer -topology "topology_file.txt" -servers "servers.txt" -id S01_01 -group "01" -sleep 3000
start java -cp "bank.jar" branch.server.BranchServer -topology "topology_file.txt" -servers "servers.txt" -id S01_02 -group "01" -sleep 3000
start java -cp "bank.jar" branch.server.BranchServer -topology "topology_file.txt" -servers "servers.txt" -id S01_03 -group "01" -sleep 3000
